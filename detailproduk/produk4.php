    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <img src="/ndrshoop/img/produk-4.jpeg" alt="Gambar Anda" class="img-fluid">
            </div>
            ...
            <div class="col-md-6">
                <!-- Keterangan Gambar -->
                <h2>Kue bangkit</h2>
                <p> <b> Komposisi : </b> tepung terigu, santan, gula pasir, soda bangkit, pewarna makanan</p>
                ...
                <button class="btn text-light mt-3" style="background-color: #B0578D;" onclick="tambahProduk('Kue bangkit')">

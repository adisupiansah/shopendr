    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <img src="/ndrshoop/img/produk1.jpeg" alt="Gambar Anda" class="img-fluid">
            </div>

            <!-- Bagian Kanan (6 grid) -->
            <div class="col-md-6">
                <!-- Keterangan Gambar -->
                <h2>Pastel Serunding</h2>
                <p> <b> Komposisi : </b> gula pasir, tepung terigu, santan, vanili, telur, tepung sinar</p>
                ...
                <button class="btn text-light mt-3" style="background-color: #B0578D;" onclick="tambahProduk('Pastel Serunding')">

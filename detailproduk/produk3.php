    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <img src="/ndrshoop/img/produk3.jpeg" alt="Gambar Anda" class="img-fluid">
            </div>
            ...
            <div class="col-md-6">
                <!-- Keterangan Gambar -->
                <h2>Dodol ketan</h2>
                <p> <b> Komposisi : </b> gula pasir, gula marah, pewarna makanan, tepung ketan, santan</p>
                ...
                <button class="btn text-light mt-3" style="background-color: #B0578D;" onclick="tambahProduk('Dodol ketan')">

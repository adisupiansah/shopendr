    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <img src="/ndrshoop/img/produk55.jpeg" alt="Gambar Anda" class="img-fluid">
            </div>
            ...
            <div class="col-md-6">
                <!-- Keterangan Gambar -->
                <h2>Bahulu lembut</h2>
                <p> <b> Komposisi : </b>  telur, gula pasir, tepung terigu, vanili</p>
                ...
                <button class="btn text-light mt-3" style="background-color: #B0578D;" onclick="tambahProduk('Bahulu lembut')">
